  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="flex min-h-screen flex-col items-center justify-center px-5 py-10 text-center">
        <div className="relative mb-8 w-full max-w-md overflow-hidden rounded-[28px] border border-white/10 bg-zinc-950 shadow-[0_32px_90px_rgba(0,0,0,0.45)] mx-auto">
          <video
